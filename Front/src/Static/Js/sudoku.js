...
sudoku.SQUARES = null;             // Square IDs

sudoku.UNITS = null;               // All units (row, column, or box)
sudoku.SQUARE_UNITS_MAP = null;    // Squares -> units map
sudoku.SQUARE_PEERS_MAP = null;    // Squares -> peers map
...
sudoku._get_candidates_map = function(board){
    ...
    */
    ...
    for(var si in sudoku.SQUARES){
        candidate_map[sudoku.SQUARES[si]] = sudoku.DIGITS;
    }
...
sudoku._get_square_vals_map = function(board){
    ...
    */
    ...
    if(board.length != sudoku.SQUARES.length){
        throw "Board/squares length mismatch.";
        
    } else {
        for(var i in sudoku.SQUARES){
            squares_vals_map[sudoku.SQUARES[i]] = board[i];
        }
    }
...
sudoku.validate_board = function(board){
    ...
    */
    ...
    if(board.length !== sudoku.NR_SQUARES){
        return "Invalid board size. Board must be exactly " + sudoku.NR_SQUARES +
                " squares.";
    }
